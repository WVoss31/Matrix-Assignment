...
public interface Matrix {
    ...
    default Matrix transpose() {
        Matrix transposed_matrix = new ArrayListImplementation(getNumColumns(), getNumRows());
    ...
    default void makeIdentity() {
        ...
        for (int i = 0; i < getNumRows(); i++) {
            ...
            throw new MatrixException(String.format("cannot make identity, matrix is not even"));
        }
    }
